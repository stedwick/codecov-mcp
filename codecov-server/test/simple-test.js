...
/**
 * Simple test script for the Codecov MCP server
 * 
 * This script tests the basic functionality of the Codecov MCP server by:
 * 1. Listing available tools
 * 2. Testing the find_low_coverage_files tool with mock data
 */
...
async function testMcpServer() {
    try {
        ...
        console.log('\n[Test] Step 1: Listing available tools');
        ...
        console.log('\n[Test] Step 2: Calling find_low_coverage_files tool');
